...
| **HC** | **Cimientos** (S127, plan en [[Index/28 - Cimientos y camino a Game Ready]]) | Abrir el juego desde cero, recibir sus primeras criaturas, comprar y poseer, ver dos monedas (dabloons y Minerita), pausar, salir y no perder el guardado entre PCs. | C1 limpieza del combate viejo · C2 guardado con versión, fecha y push agrupado · C3 cartera de dos monedas · C4 ciclo de vida de la criatura · C5 catálogo unificado con propiedad · C6 reloj de juego · C7 cáscara y arranque; pruebas de lógica pura y primera build de PC. | 10-12 |
| **H1** | **Loop vertical cerrado** (S127: pasa a ser el loop de dos monedas, ver `Index/28` §5) | Criar con el material que trajo, ver las necesidades, quedarse sin energía y tener que esperar, perder una criatura de verdad. | Uso del material en la cría (moneda de evolución, `Index/18` 1.1); necesidades en UI y gate real de energía; permadeath activo con aviso; 30 min jugables sin MCP; "¿por qué crío otro?" tiene una primera respuesta jugada. | 3-5 |
