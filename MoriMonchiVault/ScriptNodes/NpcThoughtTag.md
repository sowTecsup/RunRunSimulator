...
**Conexiones:** [[NpcAgent]] (lee `State`, `Reason`, `ReactionDelay`, `TargetMM`, `DisplayName`), [[NpcDialogueBank]] (consulta frases por situación), [[CreatureDNA]] (lee `CustomName`), [[CustomerArchetypeSO]] (fallback displayName), [[UiPanels]]
