...
- Chips: "Tú" (self, highlighted), "Madre", "Padre" (labels role), color BaseColor, tachado si dead
...
- Chips: "Pareja" (padre/madre en descendencia), "Cría" (hijos), color BaseColor
...
- `tree-chip` (círculo + nombre + role label, con clases `tree-chip--self`, `tree-chip--unknown`, `tree-dead`)
- `tree-swatch` (backgroundColor del chip = BaseColor)
...
**Conexiones:** [[MorimonchiDetailInfoUITK]], [[CreatureDatabaseSO]], [[CreatureRegistrySO]]
